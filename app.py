...
df = pd.read_csv('res\\athlete_events.csv')
region_df = pd.read_csv('res\\noc_regions.csv')
...
if user_menu == 'Country-wise Analysis':
    ...
    x = helper.countrywise_medal_tally(df, selected_country)
    ...
    temp_df = helper.countrywise_most_successful(df, selected_country)
    st.table(temp_df)
...
if user_menu == 'Athlete wise Analysis':
    ...
    ax = sns.scatterplot(temp_df, x='Weight', y='Height', hue=temp_df['Medal'], style=temp_df['Sex'], s=100)
    st.pyplot(fig)
